> [!WARNING]
> Данный форк модуля находится в нестабильном состоянии и может вызывать ошибки.
> 
> **Если вы хотите помочь в разработке, улучшить работу или исправить существующие недочёты и баги, пожалуйста, создавайте issue или отправляйте PR.**
